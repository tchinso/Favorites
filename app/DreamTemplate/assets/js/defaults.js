...
const BASE_STYLE_CONFIGS = [
  ...
  { id: "cheki", label: "Cheki Maker", accent: "#ff8ab5", canExportImage: false, canExportHtml: false, description: "사진, 싸인, 글씨, 스티커, 효과, 프레임을 내장 Cheki Maker에서 만들고 PNG 또는 GIF로 저장합니다." },
...
const STYLE_VARIANTS = [
  ...
  { id: "cheki-maker", baseStyle: "cheki", groupId: "gallery", label: "체키", description: "Cheki Maker의 원본 캔버스와 모든 편집 수치를 그대로 사용합니다. PNG와 GIF 저장은 미리보기 안에서 할 수 있습니다." },
