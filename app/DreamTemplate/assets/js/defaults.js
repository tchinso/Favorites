...
const BASE_STYLE_CONFIGS = [
  ...
  },
  {
    ...
    canExportImage: true,
    canExportHtml: true,
    description: "musicplayer2.html 원본 편집기를 그대로 불러오는 음악 플레이어입니다.",
  },
  {
    id: "timeline",
    label: "Single Line",
  ...
  { id: "cheki", label: "Cheki Maker", accent: "#ff8ab5", canExportImage: true, canExportHtml: true, description: "사진, 싸인, 글씨, 스티커, 효과, 프레임을 내장 Cheki Maker에서 만들고 PNG, GIF 또는 HTML로 저장합니다." },
...
const STYLE_VARIANTS = [
  ...
  { id: "musicplayer-card", baseStyle: "musicplayer", groupId: "musicplayer", label: "플레이어 A타입", description: "앨범 커버와 플레이어 UI가 있는 음악 카드입니다." },
  { id: "musicplayer-type-b", baseStyle: "musicplayer2", groupId: "musicplayer", label: "플레이어 B타입", description: "musicplayer2.html 원본 편집기를 그대로 불러옵니다." },
  ...
  { id: "cheki-maker", baseStyle: "cheki", groupId: "gallery", label: "체키", description: "Cheki Maker의 원본 캔버스와 모든 편집 수치를 그대로 사용합니다. PNG와 HTML은 상단에서, GIF는 내보내기 섹션에서 저장합니다." },
...
const DEFAULT_STYLE_DATA = {
  ...
  renaitvshow: {
    ...
    singleMode: false,
    leftFullImage: "",
    leftFullImageScale: 100,
    leftFullImagePanX: 0,
    leftFullImagePanY: 0,
    rightFullImage: "",
    rightFullImageScale: 100,
    rightFullImagePanX: 0,
    rightFullImagePanY: 0,
    relationA: "캐릭터 관계 서술",
    relationB: "캐릭터 관계 서술",
    cards: [
      {
